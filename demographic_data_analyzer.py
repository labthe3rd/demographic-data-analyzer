...
#   Date:           10/04/2023
#   Desc:           A python script that grabs data from a csv file then returns it in a formatted way
...
def calculate_demographic_data(print_data=True):
    ...
    #Count the different variances of race
    ...
    )  # count number of entries with bachelors, masters, and doctorate
    ...
    #Grab the opposite of higher education
